...
Процедура Записать(ИспользуемыеПроектыДоски, Отказ) Экспорт
	...
	Попытка
		...
		Для Каждого ДанныеПроекта Из ИспользуемыеПроектыДоски Цикл
			...
			СтрокаЗаписи.Цвет = канбан_КанбанДоска.СтрокаИзЦвета(ДанныеПроекта.Цвет);
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			"OneKanban: Запись регистра сведений канбан_ИспользуемыеПроектыДоски", 
...
Процедура Загрузить(ПроектыДоски) Экспорт
	...
	Для Каждого СтрокаНабора Из НаборЗаписей Цикл
		...
		СтрокаПроектыДоски.Цвет = канбан_КанбанДоска.ЦветИзСтроки(СтрокаНабора.Цвет);
