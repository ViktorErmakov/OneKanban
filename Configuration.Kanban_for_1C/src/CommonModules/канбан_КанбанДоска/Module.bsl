...
//
Функция СтатусОбъектаПоИдентификатору(Знач ИмяОпределяемогоТипа, Знач ИдентификаторСтатусаСтрока) Экспорт
	
	ТипОбъектаСтатус = Метаданные.ОпределяемыеТипы[ИмяОпределяемогоТипа].Тип.Типы()[0];
	СтатусСсылка = Новый (ТипОбъектаСтатус); // ОпределяемыйТип.канбан_СтатусыЗадач, ОпределяемыйТип.канбан_СтатусыОшибок
	...
	канбан_КанбанДоскаПереопределяемый.СтатусОбъектаПоИдентификатору(ИмяОпределяемогоТипа, ИдентификаторСтатусаСтрока, СтатусСсылка);
