...
Функция ИзменитьСтатусЗадаче(ДанныеПриИзмененииСтатуса, Отказ) Экспорт
	...
	канбан_КанбанДоскаПереопределяемый.ИзменитьСтатусЗадаче(ЗадачаСсылка, СтатусСсылка, ИсполнительСсылка, Отказ);
...
Функция НовыйСтатусПоИдентификаторуИМенеджеруОбъекта(ЗадачаСсылка, ИдентификаторСтатуса, ИмяМенеджераОбъектаСтатус)
	...
	Если ИспользоватьСопоставлениеСтатусов И ЭтоТипСтатусОшибки Тогда
		...
		СопоставленныйСтатус(СтатусЗадачи, НовыйСтатус);
