...
Функция НовыйСтатусПоИдентификаторуИМенеджеруОбъекта(
	...
	НовыйСтатус = СсылкаНаОбъектПоИдентификатору(ИмяМенеджераОбъектаСтатус, ИдентификаторСтатуса);// ОпределяемыйТип.канбан_СтатусыЗадач
	...
	Если ИспользоватьСопоставлениеСтатусов И ЭтоТипСтатусОшибки Тогда
		...
		НовыйСтатус = Новый (ТипОшибки); // ОпределяемыйТип.канбан_СтатусыОшибок;
		
		СопоставленныйСтатус(СтатусЗадачи, НовыйСтатус, Отказ);
