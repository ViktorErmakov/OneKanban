...
Процедура ОткрытьСтраницуДокументации() Экспорт
	ЗапуститьПриложение("https://viktorermakov.github.io/OneKanban/");
КонецПроцедуры
...
//  Событие - Строка
//  Ответ - Неопределено, см. канбан_КанбанДоскаКлиентСервер.НовыйНастройкиДоски
//
...
// * card__text - Строка
// * status - Строка
// * urgencyId - Строка - срочность задачи
// * isBug - Булево - это ошибка
//
Функция НовыйДанныеЗадачиДляДоски() Экспорт
	...
	ДанныеОтвета.Вставить("urgencyId", "");
	ДанныеОтвета.Вставить("isBug", Ложь);
