...
Процедура ТекстHTMLКанбанДоски(
	...
	// TODO: Тут нужно собрать все проекты в массив и в JSON засунуть вот сюда
	// <div id="project_picker" data-projects='[{"id":"project-123","name":"Проект А","color":"rgb(255,0,0)"},{"id":"project-456","name":"Проект Б","color":null}]'></div>
