...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИмяСправочникаЗадачи = Метаданные.ОпределяемыеТипы.канбан_Задачи.ПолноеИмя();
...
Процедура КанбанДоскаПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка)
	...
	Если Кнопка.id = "V8_request" Тогда
		...
		Если Кнопка.value = "changeStatus" Тогда
			...
			ИдентификаторЗадача = СтрЗаменить(Кнопка.attributes["idtask"].nodeValue, "task", ""); // Строка
