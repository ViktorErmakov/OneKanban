...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтключитьОтправкуСтатистики = Константы.канбан_ОтключитьОтправкуСтатистики.Получить();
	
	АдресЛоготипа = БиблиотекаКартинок.канбан_ЛоготипТекст;
	
	ИспользуемыеПроектыДоскиЦветПриИзмененииСервер();
	
	ОтображатьФотографиюИсполнителя = канбан_КанбанДоска.ПоказыватьФотографиюИсполнителяПоНастройкамДоски();
...
&НаКлиенте
Процедура ОтключитьОтправкуСтатистикиПриИзменении(Элемент)
	
	ОтключитьОтправкуСтатистикиПриИзмененииСервер();
...
Процедура ЗаписатьНаСервере(Отказ)
	...
	Если Не Отказ Тогда
		...
		НастройкиДоскиJSON = канбан_КанбанДоска.ЗагрузитьТекщиеНастройкиДоски();
		НастройкиДоскиJSON.showexecutorphoto = ОтображатьФотографиюИсполнителя;
		канбан_КанбанДоска.СохранитьТекущиеНастройкиДоски(НастройкиДоскиJSON);
...
&НаСервере
Процедура ОтключитьОтправкуСтатистикиПриИзмененииСервер()
	
	ОтключитьОтправкуСтатистикиЗапись();
	
КонецПроцедуры

&НаСервере
Процедура ОтключитьОтправкуСтатистикиЗапись()
	
	ОтключитьОтправкуСтатистикиСохраненное = Константы.канбан_ОтключитьОтправкуСтатистики.Получить();
	Если ОтключитьОтправкуСтатистикиСохраненное <> ОтключитьОтправкуСтатистики Тогда
		
		Константы.канбан_ОтключитьОтправкуСтатистики.Установить(ОтключитьОтправкуСтатистики);
