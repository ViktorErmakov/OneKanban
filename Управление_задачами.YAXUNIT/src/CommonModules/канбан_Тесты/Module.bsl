...
//			.ДобавитьКлиентскийТест("ИзменитьСтатусЗадачиВРежимеГруппировкиПоИсполнителям")
//			.ДобавитьКлиентскийТест("ИзменитьПользователяЗадачиВРежимеГруппировкиПоИсполнителям")
//			.ДобавитьКлиентскийТест("СозданиеЗадачиВнеДоски")
//			.ДобавитьКлиентскийТест("СохраниениеНастроекДоски")
//			.ДобавитьКлиентскийТест("ЗагрузкаНастроекДоски")
...
Процедура канбан_ТекстHTML_ЧетыреПроекта_ГруппировкаПроекты_ИзмнениеСтатуса() Экспорт
	...
	канбан_ТестыВызовСервера.ИзменитьСтатусЗадаче();
	...
	// TODO Нужно изменить статус обратно
...
&НаСервере
Процедура ИзменитьСтатусЗадаче(	
	Знач ИдентификаторЗадачаСтрока, Знач НовыйСтатусИдентификатор, ТекущийСтатусИдентификатор = "") Экспорт
...
//	МенеджерСтатус = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени(МетаданныеСтатус.ПолноеИмя());
	...
	// TODO: тут нужно статус конкретный получить. А что если статус перечисление?
//	НовыйСтатусИдентификатор = "a1ca3367-c296-11ee-93e4-107b4419808b"; // СтатусКПереносуВРабочую
//	СтатусКПереносуВРабочую = СоздатьНовыйОбъектСправочника(МетаданныеСтатус.ПолноеИмя(), НовыйСтатусИдентификатор, "");
