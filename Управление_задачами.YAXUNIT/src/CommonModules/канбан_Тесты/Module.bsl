...
Процедура ИзменитьДанныеОшибки(
	...
	МетаданныеСтатус = Метаданные.НайтиПоТипу(ТипСтатус);
	МенеджерСтатус = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени(МетаданныеСтатус.ПолноеИмя());
	НовыйСтатусОшибки = МенеджерСтатус.ПустаяСсылка();
	РегистрыСведений.канбан_СопоставлениеСтатусов.СопоставленныйСтатусОшибки(НовыйСтатусСсылка, НовыйСтатусОшибки, Отказ);
