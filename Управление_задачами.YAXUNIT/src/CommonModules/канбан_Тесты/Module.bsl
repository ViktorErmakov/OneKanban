...
Процедура ИсполняемыеСценарии() Экспорт
	...
	ЮТТесты
		...
		.ДобавитьТестовыйНабор("канбан_КанбанДоска")
			...
			.ДобавитьСерверныйТест("ВидСозданияСКанбанДоскиПоНастройкам_ТолькоЗадачиНаДоске")
			.ДобавитьСерверныйТест("ВидСозданияСКанбанДоскиПоНастройкам_ТолькоОшибкиНаДоске")
			.ДобавитьСерверныйТест("ВидСозданияСКанбанДоскиПоНастройкам_ДваТипаФильтрЗадача")
			.ДобавитьСерверныйТест("ВидСозданияСКанбанДоскиПоНастройкам_ДваТипаБезФильтра")
			.ДобавитьСерверныйТест("ПараметрыОткрытияФормыСозданияСЭлементыДоски_Задача")
			.ДобавитьСерверныйТест("ПараметрыОткрытияФормыСозданияСЭлементыДоски_ОшибкаБезСопоставления")
		.ДобавитьТестовыйНабор("канбан_КанбанДоска_Клиент")
			.ДобавитьКлиентскийТест("канбан_ВсеПроекты")
			.ДобавитьКлиентскийТест("канбан_ВсеПроекты_Сопоставление")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_НетВыбора")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ИзмнениеСтатуса")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_Темная")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ГруппировкаПроекты_Темная")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ГруппировкаИсполнитель_Темная")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ПоискПоСтроке_Темная")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ПоискПоСтроке_ГруппировкаИсполнитель_Темная")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ПоискПоСтроке_ГруппировкаПроекты_Темная")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ГруппировкаПроекты_Темная_ИзменениеСтатуса")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ГруппировкаИсполнитель_ИзменениеСтатуса")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ГруппировкаИсполнитель_ИзменениеПользователя")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_СозданиеЗадачиВнеДоски")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_Срочность_Немедленно")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_Срочность_ЖелательноБыстрее")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_Срочность_ВПлановомПорядке")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ВключеноСопоставление_Заполнено")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ВключеноСопоставление_Заполнено_Тип_Ошибка")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ВключеноСопоставление_НеЗаполнено")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_СозданиеОшибкиВнеДоски")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_ИзменитьСтатусОшибке")
			.ДобавитьКлиентскийТест("канбан_ЧетыреПроекта_УбратьОтображениеЗадачиНаДоске")
		...
		.ДобавитьТестовыйНабор("канбан_КанбанДоскаПереопределяемый")
			...
			.ДобавитьСерверныйТест("ТекстЗапросаОтчетаИсторияЗадач")
		.ДобавитьТестовыйНабор("канбан_Задачи")
			.ДобавитьСерверныйТест("ПустойРедактор")
		.ДобавитьТестовыйНабор("канбан_ИсторияСтатусовЗадач")
			.ДобавитьСерверныйТест("ИсторияСтатусовПриСменеСтатусаНаДоске")
			.ДобавитьСерверныйТест("ИсторияСтатусовПриСменеСтатусаОшибки")
		;
...
Процедура ПередВсемиТестами() Экспорт
	...
	РегистрыСведений.канбан_ИсторияСтатусовЗадач.ОчиститьИсторию();
...
Процедура ПередВсемиТестами() Экспорт
	...
	канбан_ТестыВызовСервера.ОчиститьКаталогСнимковHTMLДляМакетов();
...
&НаСервере
Процедура ВидСозданияСКанбанДоскиПоНастройкам_ТолькоЗадачиНаДоске() Экспорт
	
	НастройкиДоски = канбан_КанбанДоскаКлиентСервер.НовыйНастройкиДоски();
	ЮТест.ОжидаетЧто(канбан_КанбанДоска.ВидСозданияСКанбанДоскиПоНастройкам(НастройкиДоски, Истина, Ложь))
		.Равно("task");
	
КонецПроцедуры

&НаСервере
Процедура ВидСозданияСКанбанДоскиПоНастройкам_ТолькоОшибкиНаДоске() Экспорт
	
	НастройкиДоски = канбан_КанбанДоскаКлиентСервер.НовыйНастройкиДоски();
	ЮТест.ОжидаетЧто(канбан_КанбанДоска.ВидСозданияСКанбанДоскиПоНастройкам(НастройкиДоски, Ложь, Истина))
		.Равно("bug");
	
КонецПроцедуры

&НаСервере
Процедура ВидСозданияСКанбанДоскиПоНастройкам_ДваТипаФильтрЗадача() Экспорт
	
	НастройкиДоски = канбан_КанбанДоскаКлиентСервер.НовыйНастройкиДоски();
	НастройкиДоски.cardtypefilter.Добавить("task");
	ЮТест.ОжидаетЧто(канбан_КанбанДоска.ВидСозданияСКанбанДоскиПоНастройкам(НастройкиДоски, Истина, Истина))
		.Равно("task");
	
КонецПроцедуры

&НаСервере
Процедура ВидСозданияСКанбанДоскиПоНастройкам_ДваТипаБезФильтра() Экспорт
...
&НаСервере
Процедура ПараметрыОткрытияФормыСозданияСЭлементыДоски_Задача() Экспорт
	...
	ПараметрыФормы = канбан_КанбанДоска.ПараметрыОткрытияФормыСозданияСЭлементыДоски("task", СсылкаСтатуса);
	
	ОжидаемоеИмя = СтрШаблон("%1.ФормаОбъекта", канбан_КанбанДоска.ПолноеИмяОбъектаМетаданныхОпределяемогоТипа("канбан_Задачи"));
	ЮТест.ОжидаетЧто(ПараметрыФормы.ИмяФормы).Равно(ОжидаемоеИмя);
	ЮТест.ОжидаетЧто(ПараметрыФормы.ПараметрыОткрытия.Статус).Равно(СсылкаСтатуса);
	
КонецПроцедуры

&НаСервере
Процедура ПараметрыОткрытияФормыСозданияСЭлементыДоски_ОшибкаБезСопоставления() Экспорт
	...
	ПараметрыФормы = канбан_КанбанДоска.ПараметрыОткрытияФормыСозданияСЭлементыДоски("bug", СсылкаСтатуса);
	
	ОжидаемоеИмя = СтрШаблон("%1.ФормаОбъекта", канбан_КанбанДоска.ПолноеИмяОбъектаМетаданныхОпределяемогоТипа("канбан_Ошибки"));
	ЮТест.ОжидаетЧто(ПараметрыФормы.ИмяФормы).Равно(ОжидаемоеИмя);
	
	ЗначениеСтатуса = Неопределено;
	ЕстьКлючСтатус = ПараметрыФормы.ПараметрыОткрытия.Свойство("Статус", ЗначениеСтатуса);
	ЮТест.ОжидаетЧто(ЕстьКлючСтатус).Равно(Ложь);
...
&НаКлиенте
Процедура канбан_ВсеПроекты() Экспорт
	
	АдресТекущихПроектов = "";
	канбан_ТестыВызовСервера.канбан_ВсеПроекты_Очистить(АдресТекущихПроектов);
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ВсеПроекты", РеквизитКанбанДоска);
	
	канбан_ТестыВызовСервера.канбан_ВсеПроекты_Загрузить(АдресТекущихПроектов);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ВсеПроекты_Сопоставление() Экспорт
	...
	// проверить до добавления проектов, как есть форму
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ВсеПроекты_Сопоставление", РеквизитКанбанДоска);
...
&НаКлиенте
Процедура канбан_ЧетыреПроекта_НетВыбора() Экспорт
	...
	// проверить до добавления проектов, как есть форму
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_НетВыбора", РеквизитКанбанДоска);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ЧетыреПроекта() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта", РеквизитКанбанДоска);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ЧетыреПроекта_ИзмнениеСтатуса() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ИзмнениеСтатуса", РеквизитКанбанДоска);
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски("канбан_ЧетыреПроекта", РеквизитКанбанДоска);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ЧетыреПроекта_Темная() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_Темная", РеквизитКанбанДоска);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ЧетыреПроекта_ГруппировкаПроекты_Темная() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ГруппировкаПроекты_Темная", РеквизитКанбанДоска);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ЧетыреПроекта_ГруппировкаИсполнитель_Темная() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ГруппировкаИсполнитель_Темная", РеквизитКанбанДоска);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ЧетыреПроекта_ПоискПоСтроке_Темная() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ПоискПоСтроке_Темная", РеквизитКанбанДоска);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ЧетыреПроекта_ПоискПоСтроке_ГруппировкаИсполнитель_Темная() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ПоискПоСтроке_ГруппировкаИсполнитель_Темная", РеквизитКанбанДоска);
...
&НаКлиенте
Процедура канбан_ЧетыреПроекта_ПоискПоСтроке_ГруппировкаПроекты_Темная() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ПоискПоСтроке_ГруппировкаПроекты_Темная", РеквизитКанбанДоска);
...
&НаКлиенте
Процедура канбан_ЧетыреПроекта_ГруппировкаПроекты_Темная_ИзменениеСтатуса() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ГруппировкаПроекты_Темная_ИзменениеСтатуса", РеквизитКанбанДоска);
...
&НаКлиенте
Процедура канбан_ЧетыреПроекта_ГруппировкаИсполнитель_ИзменениеСтатуса() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ГруппировкаИсполнитель_ИзменениеСтатуса_Темная", РеквизитКанбанДоска);
...
&НаКлиенте
Процедура канбан_ЧетыреПроекта_ГруппировкаИсполнитель_ИзменениеПользователя() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ГруппировкаИсполнитель_ИзменениеПользователя_Темная", РеквизитКанбанДоска);
...
&НаКлиенте
Процедура канбан_ЧетыреПроекта_СозданиеЗадачиВнеДоски() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_СозданиеЗадачиВнеДоски", РеквизитКанбанДоска);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ЧетыреПроекта_Срочность_Немедленно() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_Срочность_Немедленно", РеквизитКанбанДоска);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ЧетыреПроекта_Срочность_ЖелательноБыстрее() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_Срочность_ЖелательноБыстрее", РеквизитКанбанДоска);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ЧетыреПроекта_Срочность_ВПлановомПорядке() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_Срочность_ВПлановомПорядке", РеквизитКанбанДоска);
	
КонецПроцедуры

&НаКлиенте
Процедура канбан_ЧетыреПроекта_ВключеноСопоставление_Заполнено() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ВключеноСопоставление_Заполнено", РеквизитКанбанДоска);
...
&НаКлиенте
Процедура канбан_ЧетыреПроекта_ВключеноСопоставление_Заполнено_Тип_Ошибка() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ВключеноСопоставление_Заполнено_Тип_Ошибка", РеквизитКанбанДоска);
...
&НаКлиенте
Процедура канбан_ЧетыреПроекта_ВключеноСопоставление_НеЗаполнено() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ВключеноСопоставление_НеЗаполнено", РеквизитКанбанДоска);
...
&НаКлиенте
Процедура канбан_ЧетыреПроекта_СозданиеОшибкиВнеДоски() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_СозданиеОшибкиВнеДоски", РеквизитКанбанДоска);
...
&НаКлиенте
Процедура канбан_ЧетыреПроекта_ИзменитьСтатусОшибке() Экспорт
	
	канбан_ТестыВызовСервера.ИспользоватьСопоставлениеСтатусов(Истина);
	
	ИдентификаторОшибкаСтрока = "894d3446-bffc-11f0-954d-107b4419808b"; // Ошибка #1
	НовыйСтатусИдентификаторСтрока = "a1ca3363-c296-11ee-93e4-107b4419808b"; // ВПроцессеВыполнения
	ТекущийСтатусИдентификаторСтрока = "";
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_ИзменитьСтатусОшибке", РеквизитКанбанДоска);
	
	ТекущийСтатусИдентификаторСтрока = "a1ca3366-c296-11ee-93e4-107b4419808b"; // Зарегистрирована
...
&НаКлиенте
Процедура канбан_ЧетыреПроекта_УбратьОтображениеЗадачиНаДоске() Экспорт
	...
	канбан_ТестыВызовСервера.ПроверитьТекстHTMLКанбанДоски(
		"канбан_ЧетыреПроекта_УбратьОтображениеЗадачиНаДоске", РеквизитКанбанДоска);
...
&НаСервере
Процедура ТекстЗапросаОтчетаИсторияЗадач() Экспорт
	
	СохраненноеИспользованиеСопоставления = Константы.канбан_ИспользоватьСопоставлениеСтатусов.Получить();
	
	Попытка
		
		Константы.канбан_ИспользоватьСопоставлениеСтатусов.Установить(Ложь);
		ПроверитьТекстЗапросаОтчетаИсторияЗадач(Ложь);
		
		Константы.канбан_ИспользоватьСопоставлениеСтатусов.Установить(Истина);
		ПроверитьТекстЗапросаОтчетаИсторияЗадач(Истина);
		
	Исключение
		
		Константы.канбан_ИспользоватьСопоставлениеСтатусов.Установить(СохраненноеИспользованиеСопоставления);
		ВызватьИсключение;
...
&НаСервере
Процедура ПроверитьТекстЗапросаОтчетаИсторияЗадач(ИспользуетсяВедениеОшибок)
	
	ТекстЗапроса = канбан_КанбанДоскаПереопределяемый.ТекстЗапросаОтчетаИсторияЗадач();
	
	Ожидание = ЮТест.ОжидаетЧто(ТекстЗапроса)
		.Содержит("&ВключатьЗадачи")
		.НеСодержит("канбан_СопоставлениеСтатусов");
	
	Если ИспользуетсяВедениеОшибок Тогда
		Ожидание
			.Содержит("&ВключатьОшибки")
			.Содержит("канбан_Ошибки")
			.Содержит("ОБЪЕДИНИТЬ")
			.Содержит("&СтатусОшибки");
	Иначе
		Ожидание
			.НеСодержит("&ВключатьОшибки")
			.НеСодержит("канбан_Ошибки")
			.НеСодержит("ОБЪЕДИНИТЬ");
	КонецЕсли;
	...
	Запрос.УстановитьПараметр("Проект", Новый Массив);
	Запрос.УстановитьПараметр("Задача", Новый Массив);
	Запрос.УстановитьПараметр("Статус", Новый Массив);
	Запрос.УстановитьПараметр("СтатусОшибки", Новый Массив);
	Запрос.УстановитьПараметр("Исполнитель", Новый Массив);
	Запрос.УстановитьПараметр("ТолькоОткрытыеИнтервалы", Ложь);
	Запрос.УстановитьПараметр("ВключатьЗадачи", Истина);
	Запрос.УстановитьПараметр("ВключатьОшибки", ИспользуетсяВедениеОшибок);
	РезультатЗапроса = Запрос.Выполнить();
	
	Ютест.ОжидаетЧто(РезультатЗапроса.Колонки)
		.ЛюбойЭлементСодержитСвойствоСоЗначением("Имя", "Задача")
		.ЛюбойЭлементСодержитСвойствоСоЗначением("Имя", "ДлительностьЧасов")
		.ЛюбойЭлементСодержитСвойствоСоЗначением("Имя", "ИнтервалОткрыт")
		;
...
Процедура ПроверитьТекстHTMLКанбанДоски(Знач ИмяМакетаЭталона, ТекстДоски = "") Экспорт
	...
	СохранитьСнимокHTMLДляМакетов(ИмяМакетаЭталона, ТекстДоски);
	
	МакетТекста = ПолучитьОбщийМакет(ИмяМакетаЭталона);
	ТекстHTMLДоскиЭталон = МакетТекста.ПолучитьТекст();
	ТекстHTMLДоскиЭталон = НормализоватьТекст(ТекстHTMLДоскиЭталон);
...
// Сохраняет текст доски в файл для последующего переноса в макет (npm run yaxunit:apply-snapshots).
// Каталог вычисляется из projectPath YAXUnit (см. КаталогСнимковHTMLДляМакетов). Если файл снимка уже существует — не перезаписываем.
// При ошибке записи тест не падает.
//
&НаСервере
Процедура СохранитьСнимокHTMLДляМакетов(Знач ИмяМакетаЭталона, Знач ТекстДляСнимка)
	
	КаталогСнимков = КаталогСнимковHTMLДляМакетов();
	Если ПустаяСтрока(КаталогСнимков) Тогда
		Возврат;
	КонецЕсли;
	
	Попытка
		
		КаталогПакета = КаталогПакетаYaxunitHtmlSnapshots();
		Если НЕ ПустаяСтрока(КаталогПакета) Тогда
			ФайлПакета = Новый Файл(КаталогПакета);
			Если НЕ ФайлПакета.Существует() Тогда
				СоздатьКаталог(КаталогПакета);
			КонецЕсли;
		КонецЕсли;
		
		ФайлКаталога = Новый Файл(КаталогСнимков);
		Если НЕ ФайлКаталога.Существует() Тогда
			СоздатьКаталог(КаталогСнимков);
		КонецЕсли;
		
		ПутьФайла = ЮТФайлы.ОбъединитьПути(КаталогСнимков, ИмяМакетаЭталона + ".snapshot.txt");
		
		ФайлСнимка = Новый Файл(ПутьФайла);
		Если ФайлСнимка.Существует() Тогда
			Возврат;
		КонецЕсли;
		
		Запись = Новый ЗаписьТекста(ПутьФайла, КодировкаТекста.UTF8);
		Запись.Записать(ТекстДляСнимка);
		Запись.Закрыть();
		
	Исключение
		// Не прерываем тесты: неверный путь, нет прав и т.п.
	КонецПопытки;
	
КонецПроцедуры

// Каталог yaxunit-html-snapshots относительно projectPath YAXUnit (корень Kanban_for_1C или Управление_задачами.YAXUNIT — см. yaxunit-html-snapshots/README.md).
//
&НаСервере
Функция КаталогПакетаYaxunitHtmlSnapshots()
	...
	Возврат ЮТФайлы.ОбъединитьПути(КаталогПроекта, "yaxunit-html-snapshots");
	
КонецФункции

// Каталог с *.snapshot.txt: <projectPath>/yaxunit-html-snapshots/test_templates (см. README).
//
&НаСервере
Функция КаталогСнимковHTMLДляМакетов()
	
	КаталогПакета = КаталогПакетаYaxunitHtmlSnapshots();
	Если ПустаяСтрока(КаталогПакета) Тогда
		Возврат "";
	КонецЕсли;
	
	Возврат ЮТФайлы.ОбъединитьПути(КаталогПакета, "test_templates");
	
КонецФункции

// Удаляет все *.snapshot.txt в КаталогСнимковHTMLДляМакетов().
// Вызывается из клиентского ПередВсемиТестами модуля канбан_Тесты перед подготовкой данных (один раз перед клиентской фазой YAXUnit),
// чтобы не стирать снимки вторым вызовом подготовки перед серверной фазой того же модуля.
// При ошибке (нет прав, путь недоступен) не прерывает подготовку тестов.
//
&НаСервере
Процедура ОчиститьКаталогСнимковHTMLДляМакетов() Экспорт
	...
	Попытка
		...
		СписокФайлов = НайтиФайлы(КаталогСнимков, "*.snapshot.txt", Ложь); // BSLLS:UsingSynchronousCalls-off
		Для Каждого ЭлементФайла Из СписокФайлов Цикл
			
			УдалитьФайлы(ЭлементФайла.ПолноеИмя); // BSLLS:UsingSynchronousCalls-off
...
Функция ТекстРеквизитаФормыКанбанДоска()
	...
	ФормаДоски = ПолучитьФорму(
		"Обработка.Канбан_Доска_HTML.Форма.Доска",
		ПараметрыФормы,
		,
		Новый УникальныйИдентификатор()); // новый экземпляр формы — актуальный HTML после изменений на сервере
...
&НаСервере
Процедура канбан_ВсеПроекты_Очистить(АдресТекущихПроектов) Экспорт
...
&НаСервере
Процедура канбан_ВсеПроекты_Загрузить(АдресТекущихПроектов) Экспорт
...
Процедура ИзменитьДанныеОшибки(
	...
	// На доске в колонку передаётся статус задачи; для ошибки нужно сопоставление.
	Константы.канбан_ИспользоватьСопоставлениеСтатусов.Установить(Истина);
	...
	МетаданныеОшибки = Метаданные.НайтиПоТипу(ТипОшибки);
	МенеджерОшибок = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени(МетаданныеОшибки.ПолноеИмя());
	ОшибкаСсылка = МенеджерОшибок.ПолучитьСсылку(ИдентификаторОшибка);
	...
	МетаданныеСтатусЗадачи = Метаданные.НайтиПоТипу(ТипСтатусЗадачи);
	МенеджерСтатусЗадачи = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени(МетаданныеСтатусЗадачи.ПолноеИмя());
	НовыйСтатусИдентификатор = Новый УникальныйИдентификатор(НовыйСтатусИдентификаторСтрока);
	НовыйСтатусЗадачиСсылка = МенеджерСтатусЗадачи.ПолучитьСсылку(НовыйСтатусИдентификатор);
	
	ТипСтатусОшибки = Метаданные.ОпределяемыеТипы.канбан_СтатусыОшибок.Тип.Типы()[0];
	МетаданныеСтатусОшибки = Метаданные.НайтиПоТипу(ТипСтатусОшибки);
	МенеджерСтатусОшибки = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени(МетаданныеСтатусОшибки.ПолноеИмя());
	НовыйСтатусОшибки = МенеджерСтатусОшибки.ПустаяСсылка();
	ОтказСопоставления = Ложь;
	канбан_КанбанДоска.СопоставленныйСтатус(НовыйСтатусЗадачиСсылка, НовыйСтатусОшибки, ОтказСопоставления);
	
	Ютест.ОжидаетЧто(ОтказСопоставления)
		.Равно(Ложь);
	Ютест.ОжидаетЧто(НовыйСтатусОшибки)
		.Заполнено();
	...
	ДанныеПриИзмененииСтатуса = Новый Структура;
	ДанныеПриИзмененииСтатуса.Вставить("ИдентификаторЗадача", ИдентификаторОшибкаСтрока);
	ДанныеПриИзмененииСтатуса.Вставить("ИмяМенеджераОбъектаЗадача", МетаданныеОшибки.ПолноеИмя());
	ДанныеПриИзмененииСтатуса.Вставить("ИдентификаторСтатуса", НовыйСтатусИдентификаторСтрока);
	ДанныеПриИзмененииСтатуса.Вставить("ИмяМенеджераОбъектаСтатус", МетаданныеСтатусЗадачи.ПолноеИмя());
	ДанныеПриИзмененииСтатуса.Вставить("ИдентификаторИсполнителя", ИдентификаторИсполнителяСтрока);
...
#Область канбан_ИсторияСтатусовЗадач

&НаСервере
Процедура ИсторияСтатусовПриСменеСтатусаНаДоске() Экспорт
	
	ЮТест.ОжидаетЧто(канбан_КанбанДоска.ИспользуетсяЗаписьВРегистр())
		.Равно(Истина);
	
	ПолноеИмяОбъектаЗадачи = канбан_КанбанДоска.ПолноеИмяОбъектаМетаданныхОпределяемогоТипа("канбан_Задачи"); // Строка
	ПолноеИмяОбъектаСтатусы = канбан_КанбанДоска.ПолноеИмяОбъектаМетаданныхОпределяемогоТипа("канбан_СтатусыЗадач"); // Строка
	
	ИдентификаторЗадачиСтрока = "e1e2e3e4-f5f6-7890-abcd-ef1234567890";
	ИдентификаторСтатусЗарегистрирована = "a1ca3366-c296-11ee-93e4-107b4419808b";
	ИдентификаторСтатусВПроцессе = "a1ca3363-c296-11ee-93e4-107b4419808b";
	ИдентификаторСтатусГотово = "a1ca3364-c296-11ee-93e4-107b4419808b";
	
	СтатусЗарегистрирована = канбан_КанбанДоска.СсылкаНаОбъектПоИдентификатору(
		ПолноеИмяОбъектаСтатусы, ИдентификаторСтатусЗарегистрирована);
	СтатусВПроцессе = канбан_КанбанДоска.СсылкаНаОбъектПоИдентификатору(
		ПолноеИмяОбъектаСтатусы, ИдентификаторСтатусВПроцессе);
	СтатусГотово = канбан_КанбанДоска.СсылкаНаОбъектПоИдентификатору(
		ПолноеИмяОбъектаСтатусы, ИдентификаторСтатусГотово);
	
	ПервыйПроект = канбан_КанбанДоска.СсылкаНаОбъектПоИдентификатору(
		канбан_КанбанДоска.ПолноеИмяОбъектаМетаданныхОпределяемогоТипа("канбан_Проекты"),
		"b49a3cc6-3026-11f0-952c-107b4419808b");
	Исполнитель = Справочники.Пользователи.НайтиПоНаименованию("Администратор", Истина);
	
	ЗадачаСсылка = ЮТест.Данные().КонструкторОбъекта(ПолноеИмяОбъектаЗадачи)
		.Установить("Наименование", НСтр("ru = 'Тест истории статусов'"))
		.УстановитьСсылкуНового(ИдентификаторЗадачиСтрока)
		.Установить("Проект", ПервыйПроект)
		.Установить("Исполнитель", Исполнитель)
		.Установить("Статус", СтатусЗарегистрирована)
		.Установить("ЭтоОсновнаяЗадача", Ложь)
	...
	История = РегистрыСведений.канбан_ИсторияСтатусовЗадач.ЗаписиИсторииПоЗадаче(ЗадачаСсылка);
	
	ЮТест.ОжидаетЧто(История.Количество())
		.Равно(1);
	ПроверитьИнтервалИстории(История, СтатусЗарегистрирована, Истина);
	
	ИзменитьДанныеЗадачи(ИдентификаторЗадачиСтрока, ИдентификаторСтатусВПроцессе);
	
	История = РегистрыСведений.канбан_ИсторияСтатусовЗадач.ЗаписиИсторииПоЗадаче(ЗадачаСсылка);
	
	ЮТест.ОжидаетЧто(История.Количество())
		.Равно(2);
	ПроверитьИнтервалИстории(История, СтатусЗарегистрирована, Ложь);
	ПроверитьИнтервалИстории(История, СтатусВПроцессе, Истина);
	
	ИзменитьДанныеЗадачи(ИдентификаторЗадачиСтрока, ИдентификаторСтатусГотово);
	
	История = РегистрыСведений.канбан_ИсторияСтатусовЗадач.ЗаписиИсторииПоЗадаче(ЗадачаСсылка);
	
	ЮТест.ОжидаетЧто(История.Количество())
		.Равно(3);
	ПроверитьИнтервалИстории(История, СтатусГотово, Истина);
	
	КоличествоОткрытых = 0;
	
	Для Индекс = 0 По История.Количество() - 1 Цикл
		Если ИнтервалИсторииОткрыт(История[Индекс].ДатаОкончания) Тогда
			КоличествоОткрытых = КоличествоОткрытых + 1;
		КонецЕсли;
	КонецЦикла;
	
	ЮТест.ОжидаетЧто(КоличествоОткрытых)
		.Равно(1);
	
КонецПроцедуры

&НаСервере
Процедура ИсторияСтатусовПриСменеСтатусаОшибки() Экспорт
	
	ПолноеИмяОбъектаОшибки = канбан_КанбанДоска.ПолноеИмяОбъектаМетаданныхОпределяемогоТипа("канбан_Ошибки");
	ПолноеИмяОбъектаСтатусыОшибок = канбан_КанбанДоска.ПолноеИмяОбъектаМетаданныхОпределяемогоТипа("канбан_СтатусыОшибок");
	
	ИдентификаторОшибкиСтрока = "f1e2d3c4-b5a6-7890-abcd-ef1234567891";
	ИдентификаторСтатусЗарегистрированаОшибка = "d0eb69d8-b7c6-11f0-954d-107b4419808b";
	ИдентификаторСтатусВПроцессеВыполненияОшибка = "d0eb69d9-b7c6-11f0-954d-107b4419808b";
	
	СтатусЗарегистрированаОшибка = канбан_КанбанДоска.СсылкаНаОбъектПоИдентификатору(
		ПолноеИмяОбъектаСтатусыОшибок, ИдентификаторСтатусЗарегистрированаОшибка);
	СтатусВПроцессеВыполненияОшибка = канбан_КанбанДоска.СсылкаНаОбъектПоИдентификатору(
		ПолноеИмяОбъектаСтатусыОшибок, ИдентификаторСтатусВПроцессеВыполненияОшибка);
	...
	ОшибкаСсылка = ЮТест.Данные().КонструкторОбъекта(ПолноеИмяОбъектаОшибки)
		.Установить("Наименование", НСтр("ru = 'Тест истории статусов ошибки'"))
		.УстановитьСсылкуНового(ИдентификаторОшибкиСтрока)
		.Установить("Проект", ПервыйПроект)
		.Установить("Исполнитель", Исполнитель)
		.Установить("Статус", СтатусЗарегистрированаОшибка)
		.Установить("СрочностьИсправления", Перечисления.канбан_СрочностьИсправления.Немедленно)
		.Записать();
	
	История = РегистрыСведений.канбан_ИсторияСтатусовЗадач.ЗаписиИсторииПоЗадаче(ОшибкаСсылка);
	
	ЮТест.ОжидаетЧто(История.Количество())
		.Равно(1);
	ПроверитьИнтервалИстории(История, СтатусЗарегистрированаОшибка, Истина);
	
	ОшибкаОбъект = ОшибкаСсылка.ПолучитьОбъект();
	ОшибкаОбъект.Статус = СтатусВПроцессеВыполненияОшибка;
	...
	ЮТест.ОжидаетЧто(История.Количество())
		.Равно(2);
	ПроверитьИнтервалИстории(История, СтатусЗарегистрированаОшибка, Ложь);
	ПроверитьИнтервалИстории(История, СтатусВПроцессеВыполненияОшибка, Истина);
	
КонецПроцедуры

&НаСервере
Функция ИнтервалИсторииОткрыт(ДатаОкончания)
	
	Возврат ДатаОкончания = Дата(1, 1, 1);
	
КонецФункции

&НаСервере
Процедура ПроверитьИнтервалИстории(История, Статус, ИнтервалОткрыт)
	
	СтрокаИстории = СтрокаИсторииПоСтатусу(История, Статус);
	
	ЮТест.ОжидаетЧто(СтрокаИстории)
		.Заполнено();
	ЮТест.ОжидаетЧто(СтрокаИстории.Статус)
		.Равно(Статус);
	ЮТест.ОжидаетЧто(ИнтервалИсторииОткрыт(СтрокаИстории.ДатаОкончания))
		.Равно(ИнтервалОткрыт);
	
КонецПроцедуры

&НаСервере
Функция СтрокаИсторииПоСтатусу(История, Статус)
	
	Строки = История.НайтиСтроки(Новый Структура("Статус", Статус));
